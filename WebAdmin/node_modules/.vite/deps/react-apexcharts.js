  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var w = function() {
      ...
      return s(t2, [{ key: "roundPathCorners", value: function(t3, e2) {
        ...
        if (X2.attr("index", a2), b2 && ("bar" === f2 && !S2.globals.isHorizontal || S2.globals.comboCharts ? X2.attr({ "clip-path": "url(#gridRectBarMask".concat(S2.globals.cuid, ")") }) : X2.attr({ "clip-path": "url(#gridRectMask".concat(S2.globals.cuid, ")") })), "none" !== S2.config.states.normal.filter.type)
    ...
    var ct = function() {
      ...
      return s(t2, [{ key: "init", value: function() {
        ...
        if ("bottom" === i2.config.legend.position)
          o2 = i2.globals.svgHeight - s2.height - 5;
          ...
          case "smooth":
            ...
            if (null === i2[a2][r2])
              ...
              switch (p2) {
                ...
                case 1:
                  if (null === i2[a2][r2 + 1])
                    x2 += L2 ? A2.line(g2, c2) : A2.move(g2, u2), b2 += A2.line(g2, S2) + A2.line(f2, S2) + "z", v2.push(x2), m2.push(b2), p2 = -1;
                  else {
        ...
        if (r2.comboCharts) {
          ...
          if (o2.column.series.length > 0)
            if (s2.chart.stacked) {
              ...
              a2.bar = new kt(a2, e2), f2.push(a2.bar.draw(o2.column.series, o2.column.i));
          ...
          switch (s2.chart.type) {
            ...
            case "bar":
              if (s2.chart.stacked)
                f2 = new At(a2, e2).draw(r2.series);
              else
                a2.bar = new kt(a2, e2), f2 = a2.bar.draw(r2.series);
              break;
            case "candlestick":
